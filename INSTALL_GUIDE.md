...
1.  Open the new folder that was created.
2.  Inside, you will find a file named **`Install.bat`**.
3.  **Double-click** the **`Install.bat`** file to start the installation.

    ![Double-click Install.bat](https://i.imgur.com/vHj2c8S.png)
    *(This is an example image. The file will be named Install.bat)*

4.  A window may pop up asking for your permission to make changes. This is expected. Click **"Yes"** to continue.
5.  A black command window will appear and automatically handle the entire installation.
